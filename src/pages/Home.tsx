        ...
        <div className="max-w-7xl mx-auto px-4">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
            ...
            <div className="text-center">
              <div className="w-72 h-72 bg-gradient-to-br   from-red-600 to-green-500 rounded-full mx-auto shadow-2xl flex items-center justify-center transform hover:scale-105 transition-all duration-300 animate-pulse">
